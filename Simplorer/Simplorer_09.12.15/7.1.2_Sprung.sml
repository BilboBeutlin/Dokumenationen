...
RESULT SDB SDB_41(  GND.V );
RESULT SDB SDB_42(  VM3.V );
RESULT VIEW VANALOG_43 (  VM3.V, Type:=ANALOG );
RESULT VIEW VANALOG_44 (  INTG1.VAL, Type:=ANALOG );
RESULT SDB SDB_45(  INTG1.VAL );
