...
INTERN  ESINE 	E1   N1:=GND,  N2:=N0053  ( FREQ := 50, TPERIO := 20m, AMPL := 1, PHASE := 0, PERIO := 1, OFF := 0, TDELAY := 0, SPC := 0, AC_PHASE := 0, AC_MAG := 1  );
...
RESULT SDB SDB_58(  INTG1.VAL );
RESULT VIEW VANALOG_59 (  VM3.V, Type:=ANALOG );
RESULT SDB SDB_60(  VM3.V );
RESULT VIEW VANALOG_61 (  INTG1.VAL, Type:=ANALOG );
